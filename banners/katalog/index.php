...
function displayProductCheckbox($items, $col_text, $col_image, $currency) {
    foreach ($items as $itemKey => $item) {
        if ($item['active']) {
            echo '<div class="d-flex flex-column box boxes" itemscope itemtype="https://schema.org/Product">';
            ...
            echo '<span class="custom-label" itemprop="name">'. $item['name'] .'</span>';
            echo '</div>';
            ...
            if (!empty($item['parameters']['value'])) {
                ...
                echo '<div class="col-6 col-md-4">'. htmlspecialchars($item['parameters']['name']) .':</div>';
                echo '<div class="col-6 col-md-3"><strong>'. htmlspecialchars($item['parameters']['value']) .'</strong></div>';
                echo '</div>';
            }
            ...
            if ($item['show_price']) {
                echo '<div class="d-flex justify-content-between align-items-center gap-1 my-3 parameters">';
                echo '<div id="'. $itemKey .'" class="product-price bg-dark text-light p-2" data-product="'. $item['name'] .'" data-value="'. $item['price'] .'">';
                ...
                <section class="row my-3" id="products">
                    ...
                    <div class="col-12 col-md-7">
                        ...
                        <?php if ($translate['package']['active']): ?>
                            <div class="d-flex flex-column box" itemscope itemtype="https://schema.org/Product">
                            ...
                            <label class="circle-checkbox">
                                        ...
                                        <div class="d-flex justify-content-end align-items-center gap-1">
                                            <div id="pack" class="product-price text-end" data-product="<?php echo $translate['package']['name'] ?>" data-value="<?php echo $translate['package']['price'] ?>">
                                                ...
                                                <?php if ($translate['package']['promo'] || $translate['package']['promo'] === 0) { ?>
                                                        ...
                                                        <small>
                                                            <del class="text-danger"><?php echo $translate['package']['price'] ?></del>
                                                        </small>
                                                ...
                                                <?php if ($translate['package']['shipping']['active']) { ?>
                                                    <div class="p-1 <?php if ($translate['package']['shipping']['class']) { ?>bg-<?php echo $translate['package']['shipping']['class'] ?> text-light<?php } ?>">
                                                        <small>
                                ...
                                <div class="detail">
                                    <!-- Rating -->
                                    <section class="rate d-flex gap-2 my-3" itemprop="reviews" itemscope itemtype="https://schema.org/AggregateRating">
