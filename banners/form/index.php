                    ...
                    <div class="col-7 my-5 col-md-3">
                        ...
                        <div id="personal">
                            <div class="form-group row">
                                <div class="col-6">
                                <input type="text" class="form-control" id="textInput" placeholder="Jan Kowalski...">
...
console.log(`viewBox: x=${viewBox.x}, y=${viewBox.y}, width=${viewBox.width}, height=${viewBox.height}`);
        ...
        function setAlignment(align) {
            if (align === "left") {
                ...
                customText.setAttribute("x", "45"); // Środek SVG
                customText.setAttribute("y", "120"); 
            } else if (align === "right") {
                customText.setAttribute("text-anchor", "end");
                customText.setAttribute("x", "82"); // Prawa krawędź SVG
                customText.setAttribute("y", "19"); // Lewa krawędź SVG
            }
        }
    </script>
    ...
    <script>
        ...
        //     let text = document.querySelector("#customText");
        //     svg.appendChild(text); // Przenosi <text> na koniec, czyli na wierzch
        // });
    </script>
</body>
</html>
