            ...
            <section class="container-fluid model">
                ...
                <div class="row options my-md-5">
                    <div class="col-7 col-md-3 my-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center gap-3 p-3 generator">
                            <label for="marker">
                        ...
                        <div id="personal">
                            <div class="form-group row fontTesterWrapper py-1 py-md-3">
                                ...
                                <ul class="">
                                    <?php
                                    // Przykład użycia czcionek
                                    foreach ($fonts as $font) {
                                        echo '<li style="font-size: 2em;font-family:'.$font['fontFamily'].'">Hussaria Electra</li>';
                                    } ?>
                                    </ul>
                                </div>
                            ...
                            <p class="info"><?php echo $translate['form']['flag']['fields']['help'] ?></p>
                                ...
                                <select class="form-select" id="fontFamilySelect" onchange="updateFontFamily()">
                                    ...
                                    <option value="Century,sans-serif" style="font-family: Century,sans-serif">Century</option>
                                    <option value="Relation,sans-serif" style="font-family: relation-one,sans-serif">Relation</option>
