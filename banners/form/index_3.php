...
$colors = loadJsonFile('colors.json', ['black' => '#000000']);
$fonts  = loadJsonFile('fonts.json', array(["name" => "Arial", "rating" => 4, "badge" => "popular", "fontFamily" => "Arial"]));
...
<body>
    ...
    <form id="orderForm">
                ...
                <div class="row options my-md-5">
                    <div class="col-7 col-md-3 my-5">
                        ...
                        <div class="generator p-3">
                            ...
                            <div id="personal">
                            <div class="form-group row fontTesterWrapper py-1 py-md-3">
        ...
        /* Stylizacja scrollbara dla przeglądarek Firefox */
        .scrollable-list {
            scrollbar-width: thin; /* Szerokość scrollbara */
            scrollbar-color: #888 #f1f1f1; /* Kolor suwaka i tła */
        }
    </style>
                                <div class="col-4 col-md-3">
                                    ...
                                    <div class="dropdown">
                                        <button id="dropdownButton" class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                                            <span id="selectedColorPack" class="me-2 bg-secondary"></span>
                                            <span id="selectedColorText" class="color-box me-2 bg-secondary"></span>
                                            Kolor
                                        </button>
                                        ...
                                        foreach ($colors as $name => $color) {
                                            echo '<li><a class="dropdown-item d-flex align-items-center color-option" data-color="'. $color .'" href="#"><span class="color-box me-2" style="background:'. $color .'"></span>'.$name.'</a></li>';
                                        } ?>
                                        </ul>
                                    </div>
                                        ...
                                        document.querySelectorAll('.color-option').forEach(item => {
                                            ...
                                            document.getElementById('selectedColorText').className = 'bg-' + color;
                                ...
                                <ul class="my-2 my-md-4 scrollable-list">
                                    <?php
                                    // ==== Fonts ====
                                    foreach ($fonts as $index => $font) {
                                        echo '<li><canvas id="canvasfont_'.$index.'" 
                                        data-font="2em ' . htmlspecialchars($font['fontFamily']) . ', sans-serif"
                            ...
                            <p class="info"><?php echo $translate['form']['flag']['fields']['help'] ?></p>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center gap-3 my-3">
                                        ...
                                        <button type="button" class="btn" id="leftSide" onclick="setAlignment('left')">
                                        ...
                                        <button type="button" class="btn" id="centerSide" onclick="setAlignment('middle')">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="35px" height="23px" viewBox="0 0 34 23" version="1.1">
                                            <g id="center">
                                            <path d="M 2.203125 0 L 31.796875 0 C 33.011719 0 34 1 34 2.234375 C 34 3.472656 33.011719 4.472656 31.796875 4.472656 L 2.203125 4.472656 C 0.988281 4.472656 0 3.472656 0 2.234375 C 0 1 0.988281 0 2.203125 0 Z M 2.203125 0 "/>
                                        ...
                                        <button type="button" class="btn" id="rightSide" onclick="setAlignment('right')">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="35px" height="23px" viewBox="0 0 34 23" version="1.1">
                                            <g id="right">
                                            <path d="M 2.203125 0 L 31.796875 0 C 33.011719 0 34 1 34 2.234375 C 34 3.472656 33.011719 4.472656 31.796875 4.472656 L 2.203125 4.472656 C 0.988281 4.472656 0 3.472656 0 2.234375 C 0 1 0.988281 0 2.203125 0 Z M 2.203125 0 "/>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="d-flex justify-content-start align-items-center gap-2 my-1 my-md-4">
                                            <input type="checkbox" id="wire" name="wire">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="prepaymentCount" name="prepaymentCount" class="form-control" min="0" step="100" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
