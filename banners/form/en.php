...
return [
    ...
    'form' => [
        ...
        'flag' => [
            ...
            'fields' => [
                'label' => 'Flag of country',
                'help' => 'Attach country flag',
                'info' => '',
            ],
        ],
        // ========================
    ...
    'package' => [
        ...
        'include' => [
            'intro_products' => 'The set includes',
            'products' => [
                'battery' => [
                    'active' => 1,
                    'name' => 'Battery',
    ...
    // ==============
    'extra' => 'Upgrade to 6.7 Now! 🚀 Get Enhanced Performance',
    'products' => [
        'battery' => [
            'active' => 1,
            'name' => 'Akumulator',
